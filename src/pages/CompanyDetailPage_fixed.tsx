...
const CompanyDetailPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-gray-100 font-sans">
            <nav className="fixed w-full z-50 bg-black bg-opacity-90 backdrop-filter backdrop-blur-lg shadow-md">
                <div className="mx-auto py-4 flex items-center justify-between px-4 sm:px-8 lg:px-20 xl:px-22">
                    {/* Logo Container */}
